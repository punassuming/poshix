...
- **Comprehensive coverage**: Completions for git, docker, npm, yarn, kubectl, cargo, pip, dotnet, Herdr, and poshix commands
...
### Terminal Workspaces
- **herdr**: Native, version-matched completions generated by `herdr completion powershell`
...
# Herdr completions
herdr pane <Tab>     # Suggests the pane commands supported by the installed version
...
│   ├── herdr.ps1            # completions generated by the installed Herdr CLI
